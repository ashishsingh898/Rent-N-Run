...
{
    public partial class CarrentContext1 : DbContext
    {
        public CarrentContext1()
        {
        }

        public CarrentContext1(DbContextOptions<CarrentContext1> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cart>(entity =>
            {
                ...
                entity.HasOne(d => d.EmailNavigation)
                    .WithMany(p => p.Carts)
                    .HasForeignKey(d => d.Email)
                    .HasConstraintName("FK__CART__EMAIL__114A936A");
            });
